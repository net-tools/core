...
class DataHelperTest extends TestCase
{
    ...
    public function testMonth2str()
    {
        ...
        $this->assertEquals('janvier', \Nettools\Core\Helpers\DataHelper::month2str(1, 'fr_FR'));
        $this->assertEquals('février', \Nettools\Core\Helpers\DataHelper::month2str(2, 'fr_FR'));
        $this->assertEquals('mars', \Nettools\Core\Helpers\DataHelper::month2str(3, 'fr_FR'));
        $this->assertEquals('avril', \Nettools\Core\Helpers\DataHelper::month2str(4, 'fr_FR'));
        $this->assertEquals('mai', \Nettools\Core\Helpers\DataHelper::month2str(5, 'fr_FR'));
        $this->assertEquals('juin', \Nettools\Core\Helpers\DataHelper::month2str(6, 'fr_FR'));
        $this->assertEquals('juillet', \Nettools\Core\Helpers\DataHelper::month2str(7, 'fr_FR'));
        $this->assertEquals('août', \Nettools\Core\Helpers\DataHelper::month2str(8, 'fr_FR'));
        $this->assertEquals('septembre', \Nettools\Core\Helpers\DataHelper::month2str(9, 'fr_FR'));
        $this->assertEquals('octobre', \Nettools\Core\Helpers\DataHelper::month2str(10, 'fr_FR'));
        $this->assertEquals('novembre', \Nettools\Core\Helpers\DataHelper::month2str(11, 'fr_FR'));
        $this->assertEquals('décembre', \Nettools\Core\Helpers\DataHelper::month2str(12, 'fr_FR'));
    }
    ...
    public function testMonth2shortstr()
    {
        ...
        $this->assertEquals('août', \Nettools\Core\Helpers\DataHelper::month2shortstr(8, 'fr_FR'));
        $this->assertEquals('sept.', \Nettools\Core\Helpers\DataHelper::month2shortstr(9, 'fr_FR'));
        $this->assertEquals('oct.', \Nettools\Core\Helpers\DataHelper::month2shortstr(10, 'fr_FR'));
        $this->assertEquals('nov.', \Nettools\Core\Helpers\DataHelper::month2shortstr(11, 'fr_FR'));
        $this->assertEquals('déc.', \Nettools\Core\Helpers\DataHelper::month2shortstr(12, 'fr_FR'));
    }
